    ...
    <div className={`container mx-auto ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="mt-10">
        ...
        {currentTabs === "HEADER" && (
          <div className="mt-10">
            <div className="flex items-center">
              <label className="w-1/5 text-lg opacity-50">Nom</label>
              <input
                value={data.name}
              ...
              {data.projects.map((project, index) => (
                <div className="mt-10" key={project.id}>
                  ...
                  <div className="flex items-center mt-5">
                    <label className="w-1/5 text-lg opacity-50">Titre</label>
                    <input
                      value={project.title}
                      onChange={(e) =>
                        editProjects(index, {
            ...
            {data.socials.map((social, index) => (
              <>
                <div key={social.id}>
                  ...
                  <div className="flex items-center mt-5">
                    <label className="w-1/5 text-lg opacity-50">Lien</label>
                    <input
                      value={social.link}
                      onChange={(e) =>
                        editSocials(index, {
